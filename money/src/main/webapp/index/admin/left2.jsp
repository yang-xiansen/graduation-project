...
<dl class="leftmenu">
	<dd>
		...
		<ul class="menuson">
			...
			<li><cite></cite><a href="user/selLg">日志管理</a><i></i></li>
			<li><cite></cite><a href="comm/selLx">通讯录</a><i></i></li>
		</ul>   
	</dd>
	<dd>
		<div class="title">
			<span><img src="<%=basePath %>resource/admin/images/leftico01.png" /></span>经费管理员管理
		</div>
		<ul class="menuson">
			<li><cite></cite><a href="user/selUser">经费管理员管理</a><i></i></li>
		</ul>   
	</dd>
	<dd>
		<div class="title">
		...
		<ul class="menuson">
			<li><cite></cite><a href="user/selUser1">用户管理</a><i></i></li>
		</ul> 
	</dd>
	<dd>
		<div class="title">
	...
	<dd>
		...
		<ul class="menuson">
			...
			<li><cite></cite><a href="comm/selCountTc">申报经费统计</a><i></i></li>
		</ul> 
	</dd>
	<dd>
		<div class="title">
