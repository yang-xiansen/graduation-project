	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<c:if test="${!empty userList}">
			...
			<tr>
				...
				<td>${list.yx}</td>
				<td>
					<a href = "user/deleteHc1?id=${list.id}" onclick="deleteUser()"><font color="blue">删除</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>	
			</tr>
			</c:forEach>
		</c:if>
		...
		<div class="pagin">
	<ul class="paginList">
	<a href="user/selUser1?page=1"><font>首页</font></a>&nbsp;&nbsp;
		共<i class="blue">&nbsp;${count}&nbsp;</i>条记录，共&nbsp;<i class="blue"> ${countPage}&nbsp;</i>页
		&nbsp;&nbsp;
	<a href="user/selUser1?page=${lastPage}">尾页</a>
	</ul>
</div>
</form>
