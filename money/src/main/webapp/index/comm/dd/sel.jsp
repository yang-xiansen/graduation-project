	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<c:if test="${!empty list}">
			...
			<tr>
				...
				<td><button  onclick="approved(this)" class="btn btn-success" value="${list.id}"><font color="blue">审核报销</font></button>&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				<td>
					<button  onclick="rejected(this)" class="btn btn-success" value="${list.id}"><font color="blue">驳回</font></button>&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
				<td>
...
<script type="text/javascript">
	...
	function approved(obj){
		$.ajax({
			url:"comm/showDd1?id="+$(obj).attr("value")
		})
	}

	function rejected(obj){
		var pro = prompt("请输入驳回理由");
		$.ajax({
			url:"comm/rejected?id="+$(obj).attr("value")+"&&reason="+pro
		})
	}
