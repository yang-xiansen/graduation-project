...
<input name="id" id="account" type="hidden"  value="${data.id}" />
	<div class="formbody">
		...
		<ul class="forminfo">
			<li>
				<label>联系人姓名</label>
				<input name="name"  value="${data.name}" type="text" class="dfinput required" placeholder="请输入联系人姓名" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			<li>
				<label>电话</label>
				<input name="tel"  value="${data.tel}" type="text" class="dfinput required" placeholder="请输入电话" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			 <li>
				<label>备注</label>
