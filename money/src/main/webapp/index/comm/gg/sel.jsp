...
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<div class="rightinfo">
			<div class="tools">
				<ul class="toolbar1">
				<li class="click"><span><img src="<%=basePath %>resource/admin/images/t01.png"/></span><a href="index/comm/gg/add.jsp">添加公告信息</a></li>
				</ul>
			</div>
		</div>
		<div class="pagin">
	<ul class="paginList">
	<a href="comm/selGg?page=1"><font>首页</font></a>&nbsp;&nbsp;
		共<i class="blue">&nbsp;${count}&nbsp;</i>条记录，共&nbsp;<i class="blue"> ${countPage}&nbsp;</i>页
		&nbsp;&nbsp;
	<a href="comm/selGg?page=${lastPage}">尾页</a>
	</ul>
</div>
</form>
